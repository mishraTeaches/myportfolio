...
const ServiceCard = ({index,title,icon}) =>{
  return (
    <Tilt className="xs:w-[250px] w-full">
      ...
      0.5*index,0.75)} className="w-full green-pink-gradient p-[1px]
...
const About = () => {
  return (
    ...
    text-[17px] max-w-3xl leading-[30px]">
      ...
      Javascript,and expertise in framworks
      like Angular,React and Three.js.I'm a quick learner
      and collaborate closely with clients,and
